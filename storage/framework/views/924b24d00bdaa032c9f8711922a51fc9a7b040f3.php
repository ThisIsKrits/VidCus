<div class="position-relative">
                ...
                <div class="col-5 col-md-8 ml-auto mr-0">
                    <div class="tm-site-nav">
                        <nav class="navbar navbar-expand-lg mr-0 ml-auto" id="tm-main-nav">
                           ...
                           <!-- desktop button -->
                           <form class="form-inline my-2 my-lg-0 d-none d-md-block btn-primary" action="<?php echo e(url('logout')); ?>" method="POST">
                               <?php echo csrf_field(); ?>
    ...
    <div class="tm-welcome-container text-center text-white">
        <div class="tm-welcome-container-inner">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn tm-btn-animate tm-btn-cta tm-icon-down">
                <span>Register</span>
            </a>
        </div>
    </div>
...
</div><?php /**PATH D:\web\video\resources\views/includes/navbar.blade.php ENDPATH**/ ?>